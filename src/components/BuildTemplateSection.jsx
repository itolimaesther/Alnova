      ...
      <div className='flex justify-center items-center gap-2 w-full'>
        ...
        <div className='flex flex-col md:flex-row w-full gap-4 md:gap-5'>
          ...
          <div className='flex-1 flex items-center justify-center mb-4 md:mb-0'>
            <div
              className='rounded-2xl w-full max-w-[220px] sm:max-w-[320px] md:max-w-[480px] h-[180px] sm:h-80 md:h-[520px] flex items-center justify-center p-0'
              style={{
            ...
            >
              <img
                src={main}
                alt='Main'
                className='w-full h-full object-cover rounded-2xl pt-2 sm:pt-6 pl-2 sm:pl-6'
              />
            </div>
          </div>
          {/* Second column (bigger, grid) */}
          <div className='flex-[1.5] grid grid-cols-1 sm:grid-cols-2 grid-rows-2 gap-2 h-[180px] sm:h-80 md:h-[520px]'>
            {secondary.map((img, idx) => (
              <div
                key={idx}
                className='rounded-2xl w-full h-24 sm:h-40 md:h-60 flex items-center justify-end p-0'
