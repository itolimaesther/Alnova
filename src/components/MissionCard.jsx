...
const MissionCard = ({
  ...
  // No arrowPos state needed for animation
  return (
    <div
    ...
    >
      ...
      {expanded && (
        <button
          className='group absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center px-6 py-2 font-semibold rounded-[46px] shadow-lg text-white text-base transition-all duration-300 min-w-[140px] justify-center overflow-hidden'
          style={{
        ...
        >
          <span className='flex items-center transition-all duration-300 group-hover:flex-row-reverse'>
            <span className='transition-all duration-300 mx-2'>
              Get started
            </span>
            <svg
              className='transition-transform duration-300 group-hover:-translate-x-2 group-hover:ml-0 ml-2'
              width='18'
              height='18'
              fill='none'
              stroke='currentColor'
